...
const increasingVisibilityofIntroText = () => {
  ...
  setTimeout(() => {
    document.querySelector(".intro-text-name-font").classList.add("after-danda");
  }, currTime);
  ...
  setTimeout(() => {
    document.querySelector(".intro-text-name-font").classList.remove("after-danda");
  }, currTime);



  setTimeout(() => {
    document.querySelector(".intro-text-developer-font").classList.add("after-danda");
  }, currTime);
  ...
  setTimeout(() => {
    document.querySelector(".intro-text-developer-font").classList.remove("after-danda");
  }, currTime);
  ...
  setTimeout(() => {
    document.querySelector(".intro-text-apps-font").classList.add("after-danda");
  }, currTime);
  ...
  setTimeout(() => {
    document.querySelector(".intro-text-apps-font").classList.remove("after-danda");
  }, currTime);
